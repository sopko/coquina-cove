...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section className="guest-review section" aria-labelledby="perfect-setting-title">
        <div className="guest-review-heading"><p className="eyebrow">Guest review</p><h2 id="perfect-setting-title">Perfect<br /><em>Setting.</em></h2></div>
